    ...
    <div className="process-card p-5 border border-white/30 rounded-3xl flex flex-col">
      ...
      <div className="process-steps flex flex-col justify-between gap-5 h-full pb-5">
        {process.map( ( step, index ) => (
          <div className="process-step flex gap-3 items-center cursor-default" key={index}>
            <div className="step-num text-[12px] w-10 h-10 rounded-full border border-[#2a2a2a] font-bold flex items-center justify-center shrink-0">{step.num}</div>
